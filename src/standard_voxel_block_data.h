...
protected:
	...
	_inline void _basics_mesh(const Ref<BasicsPreset>& basics_preset, const Array& mesh_arrays, const int& direction, const Vector3& position, const Vector3& rotation);
