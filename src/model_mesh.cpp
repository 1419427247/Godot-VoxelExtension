...
void ModelMesh::_bind_methods() {
	ClassDB::bind_method(D_METHOD("set_mesh", "value"), &ModelMesh::set_mesh);
	ClassDB::bind_method(D_METHOD("get_mesh"), &ModelMesh::get_mesh);

	ClassDB::bind_method(D_METHOD("set_materials", "value"), &ModelMesh::set_materials);
	ClassDB::bind_method(D_METHOD("get_materials"), &ModelMesh::get_materials);
...
void ModelMesh::set_mesh(const Ref<Mesh>& value) {
	mesh = value;
	if (mesh.is_null())
	{
		materials.clear();
...
Ref<Mesh> ModelMesh::get_mesh() const {
	return mesh;
}

void ModelMesh::set_materials(const TypedArray<int>& value) {
	materials = value;
	if (mesh.is_null())
	{
		materials.clear();
...
TypedArray<int> ModelMesh::get_materials() const {
	return materials;
}
